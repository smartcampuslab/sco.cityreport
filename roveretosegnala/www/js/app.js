...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    $translateProvider.translations('it', {
        ...
        signal_error_send_form_title: 'Errore',
        signal_error_send_template: 'Errore nell\'inviare i dati',
        signal_error_send_form_template: 'Inserimento dati non corretto',
    ...
    $translateProvider.translations('en', {
        ...
        signal_error_send_form_title: 'Error',
        signal_error_send_template: 'Error sending data',
        signal_error_send_form_template: 'The data are not corrected',
    ...
    $translateProvider.translations('de', {
        ...
        signal_error_send_form_title: 'Fehler',
        signal_error_send_template: 'Fehler beim Senden der Daten',
        signal_error_send_form_template: 'Fehler beim Senden der Daten',
